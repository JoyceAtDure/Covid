...
//       },
  ...
  series: [{
      name: 'India',
      data: [0,11,15,18,32,39,45,49,51,55,67,72,88,96,100,149,152,224,251,230,239,245,248,252,255,267,269,272,325,330,339,347,350,358,327,345,349,353,355,367,401,425,447],
      pointInterval:5
  }, {
      name: 'Russia',
      data: [0,4,5,7,9,10,12,16,19,23,27,30,35,45,47,50,54,68,69,70,82,96,102,109,122,130,140,151,154,165,220,228,230,239,245,248,252,255,265,269,270,325,330,339,347,350,358,359,370],
      pointInterval:5
  }, {
      name: 'Africa',
      data: [0,2,6,8,10,13,17,19,23,25,30,37,42,48,50,55,68,69,70,88,94,108,115,128,139,140,153,157,182,220,225,230,238,240,247,250,255,265,268,270,321,330,335,340,346,351,357,369],
      pointInterval:5
  }, {
      name: 'United States',
      data: [0,5,6,15,18,21,25,29,35,37,42,67,69,70,85,92,108,112,127,139,144,153,156,182,222,246,253,257,262,269,271,329,330,338,348,350,351,352,377],
      pointInterval:5
  }, {
      name: 'Brazil',
      data: [0,1,5,6,8,9,13,16,18,20,23,26,35,37,44,47,50,56,67,69,71,85,90,110,114,128,133,140,157,159,185,228,229,231,241,246,249,250,257,260,269,271,325,338,339,343,349,352,357,371],
      pointInterval:10
    },
...
Highcharts.chart('container-4', {
  ...
  title: {
      text: 'Death Trend -Since First 100 Deaths in India'
  },
          ...
          events: {
            legendItemClick: function (col) {
              if (col.target.index === 0) {
                var chart = $('#container-4').highcharts()
  ...
  series: [{
      name: 'India',
      data: [0,3,4,6,7,9,11,15,18,19,24,27,32,39,45,49,51,55,67,69,72,88,96,100,114,126,137,149,152,159,180,224,227,232,239,245,249,251,255,267,269,272,327,332,339,345,349,353,355,367],
      pointInterval:10
  }, {
      name: 'France',
      data: [0,4,5,7,9,10,12,16,19,23,27,30,35,45,47,50,54,68,69,70,82,96,102,109,122,130,140,151,154,165,220,228,230,239,245,248,252,255,265,269,270,325,330,339,347,350,358,359,370],
      ...
      name: 'Iran',
      data: [0,5,6,7,10,12,15,18,21,25,29,35,37,42,49,52,58,67,69,70,85,92,108,112,127,139,144,153,156,182,222,228,231,237,241,246,253,257,262,269,271,329,330,338,348,350,351,352,377],
      pointInterval:10
    },
...
Highcharts.chart('container-2', {
    ...
    plotOptions: {
        spline: {
            ...
            //pointStart: Date.UTC(2020, 01,01 , 0, 0, 0)
        }
    },
    series: [{
        name: 'Daily Confirmed',
...
Highcharts.chart('container-10', {
  ...
  title: {
      text: 'sample Confirmed Cases trend'
  },
